...
import com.example.game3d.authoring.grid.symbolic.advanced.segments.by_end_pos.SegmentsByEndPosition;
import com.example.game3d.authoring.grid.symbolic.advanced.segments.by_length.SegmentsByLength;
...
public class PartialSegmentHandler {
    ...
    public PartialSegmentHandler(
        ...
        if (resourcePack == null) {
            throw new IllegalArgumentException("resourcePack == null");
        }
        this.random = resourcePack.random();
    ...
    public static PartialSegmentHandler fromChildren(
        ...
        try {
            ...
            return new PartialSegmentHandler(
                    nRows, nCols, byLength, byEndPosition, resourcePack.random());
        } finally {
            scratch.clear();
        }
    }
    ...
    public GridSegment reserveRandomFitting(int length) {
        ...
        if (total <= 0) {
            throw new IllegalStateException(
                    "No free symbolic-grid segment can fit length " + length);
        }
