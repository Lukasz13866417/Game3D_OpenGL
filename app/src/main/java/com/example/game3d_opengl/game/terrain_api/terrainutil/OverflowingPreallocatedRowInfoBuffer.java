...
/**
 * Specialised overflowing, fixed-capacity circular buffer for {@link GridRowHelper} instances.
 * <p>
 * All {@code GridRowHelper} objects are pre-allocated once and then reused.
...
public class OverflowingPreallocatedRowInfoBuffer {
    ...
    public void add(long tileId,
        ...
        helper.tileId = tileId;
        helper.farLeft = farLeft;
        helper.eL = eL;
        helper.eN = eN;
        helper.startL = startL;
        helper.endR = endR;
    }
}
