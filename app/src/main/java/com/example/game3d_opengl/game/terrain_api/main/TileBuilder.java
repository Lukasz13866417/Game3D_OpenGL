...
public class TileBuilder {
    ...
    private void generateRowsForTile(Tile tile) {
        ...
        int startingPosInd = min(lastRightInd,lastLeftInd);
        System.out.println("XD: "+lastRightInd+","+lastLeftInd+" "+startingPosInd);
        ...
        for (int i = 0; i < cntRows; ++i) {
            System.out.println("XDDD "+(startingPosInd + i)+","+(startingPosInd + i - 1));
            Vector3D leftP = V3(
