package com.example.game3d_opengl.engine.util;

import static com.example.game3d_opengl.engine.util.vector.Vector3D.V3;
import static com.example.game3d_opengl.engine.util.vector.Vector3D.add;
import static com.example.game3d_opengl.engine.util.vector.Vector3D.div;
import static com.example.game3d_opengl.engine.util.vector.Vector3D.dotProduct;
import static com.example.game3d_opengl.engine.util.vector.Vector3D.sub;
