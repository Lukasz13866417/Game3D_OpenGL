 ...
 */
public final class FlatLitShaderPair<
    ...
    private static FlatLitShaderPair<VertexLayout.PositionNormalLayout> sharedShader = null;

    public static FlatLitShaderPair<VertexLayout.PositionNormalLayout> getSharedShader() {
    ...
    public static final class Builder
            extends ShaderPair.BaseBuilder<FlatLitShaderPair<VertexLayout.PositionNormalLayout>, Builder> {
        @Override
        protected Builder self() { return this; }

        @Override
        protected FlatLitShaderPair<VertexLayout.PositionNormalLayout> create(
